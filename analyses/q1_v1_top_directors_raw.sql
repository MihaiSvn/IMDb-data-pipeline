-- Version 1: Initial attempt (min 5 titles, min 1000 votes combined)
-- Insight: The results are dominated by obscure directors of short films or niche episodes due to the low vote threshold allowing easily manipulated high ratings.
